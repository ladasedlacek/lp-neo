...
$(".lpFAQs > .lpFAQs__wrapper").click(function (e) {
    ...
    return (
        $(this).hasClass("active")
            ...
            : ($(".lpFAQs > .lpFAQs__wrapper > .lpFAQs__paragraph").slideUp(), $(".lpFAQs > .lpFAQs__wrapper.active").removeClass("active"), $(this).addClass("active").find(".lpFAQs__paragraph").slideDown()),
        !1
    );
})
