...
$(".lpFAQs > .lpFAQs__wrapper").click(function (e) {
    ...
    return (
        $(this).hasClass("lpFAQs__wrapper--active")
            ...
            : ($(".lpFAQs > .lpFAQs__wrapper > .lpFAQs__paragraph").slideUp(), $(".lpFAQs > .lpFAQs__wrapper.active").removeClass("lpFAQs__wrapper--active"), $(this).addClass("lpFAQs__wrapper--active").find(".lpFAQs__paragraph").slideDown()),
        !1
    );
})
